/*********************************************************************************************************//**
 * @file    QSPI/Flash_Quad_Mode/main.c
 * @version $Rev:: 4679         $
...
void GPIO_Configuration(void)
{
  ...
  AFIO_GPxConfig(GPIO_PA, AFIO_PIN_8 | AFIO_PIN_10 | AFIO_PIN_14 | AFIO_PIN_15, AFIO_FUN_SPI);
  /* PB0: D0, PB1: D1 */
  AFIO_GPxConfig(GPIO_PB, AFIO_PIN_0 | AFIO_PIN_1, AFIO_FUN_SPI);
}
