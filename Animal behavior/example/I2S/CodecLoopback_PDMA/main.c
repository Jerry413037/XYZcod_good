...
void GPIO_Configuration(void)
{
  ...
  /* I2C                                                                                                    */
  AFIO_GPxConfig(HTCFG_I2S_SDA_GPIO_ID, HTCFG_I2S_SDA_AFIO_PIN,AFIO_FUN_I2C);
  AFIO_GPxConfig(HTCFG_I2S_SCL_GPIO_ID, HTCFG_I2S_SCL_AFIO_PIN,AFIO_FUN_I2C);
}
...
#if (SOURCE_TYPE_SEL == SOURCE_TYPE_VOICE)
  I2S_InitStructure.I2S_X_Div = (2047000*2*211/SystemCoreClock);  // MCLK = ( SystemCoreClock * I2S_X_Div / 211) / 2 = 2.047 MHz (256 x 8 kHz)
  I2S_InitStructure.I2S_Y_Div = 211;
  I2S_InitStructure.I2S_N_Div = 256 / (2 * 16) - 1;               // BCLK = 2.047 MHz / 8 = 255.924 kHz (32 x 8 kHz)
#else
  I2S_InitStructure.I2S_X_Div = (11288000*2*17/SystemCoreClock);; // MCLK = (SystemCoreClock * I2S_X_Div / 17) / 2 = 11.288 MHz (256 x 44.1 kHz)
  I2S_InitStructure.I2S_Y_Div = 17;
  I2S_InitStructure.I2S_N_Div = 256 / (2 * 16) - 1;               // BCLK = 11.288 MHz / 8 = 1411.016 kHz (32 x 44.1 kHz)
#endif
