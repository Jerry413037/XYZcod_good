...
vu8 I2C0_Master_Tx_Index=0, I2C0_Master_Rx_Index=0, \
    I2C1_Slave_Tx_Index=0,  I2C1_Slave_Rx_Index=0;
...
void I2C_Loopback(void)
{
  ...
  if (CmpBuffer(I2C0_Master_Buffer_Rx, I2C1_Slave_Buffer_Rx, BufferSize))
  {
