...
/* Private macro -------------------------------------------------------------------------------------------*/
// !!! Notice that the actually delay will be large then the calculation result since the code execution overhead !!!
#if 1 // Direct register access to reduce time overhead error
...
{
  /*--------------------------------------------------------------------------------------------------------*/
  /* Notice that the actually delay will be large then the (SystemCoreClock / n) calculation result         */
  /* since the code execution overhead.                                                                     */
  /*--------------------------------------------------------------------------------------------------------*/

  HT32F_DVB_LEDOn(HT_LED1);

  OneShot_Delay(48000);             // SystemCoreClock / 1000 = 1 ms.
  HT32F_DVB_LEDOff(HT_LED1);

  OneShot_Delay(720);               // SystemCoreClock / 1000000 * 15 = 15 us
  HT32F_DVB_LEDOn(HT_LED1);

  OneShot_Delay(48);                // SystemCoreClock / 1000000 * 1 = 1 us
  HT32F_DVB_LEDOff(HT_LED1);
}
