...
/** @addtogroup AP_Example AP Example
  * @{
  */

/* SRAM first 4 bytes as boot mode ID, replace the original SBVT[1] */
...
int main(void)
{
  ...
  NVIC_SetVectorTable(NVIC_VECTTABLE_FLASH, 0x00001000); /* Set base location of the Vector Table at 0x1000 */
